...
public class MovieDetailActivity extends BaseActivity<MovieDetailContract.MovieDetailView, MovieDetailPresenter<MovieDetailContract.MovieDetailView>> implements MovieDetailContract.MovieDetailView {
    ...
    @Override
    protected MovieDetailPresenter<MovieDetailContract.MovieDetailView> createPresenter() {
...
//                Intent intent = new Intent(MovieDetailActivity.this, PaiDataActivity.class);
